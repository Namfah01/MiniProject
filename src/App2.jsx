    ...
    <>
      <div className="bg-gradient-to-r from-pink-300 via-purple-300 to-blue-300 pt-10 text-center">
        <div className="text-4xl font-extrabold text-white">
          <h1 className="inline-block p-2 text-4xl animate-pulse font-extrabold text-White text-shadow">Dasiy AI</h1>
          <IoMdFlower className="text-yellow-200 animate-pulse inline-block mb-1" style={{ fontSize: '3 rem' }} />
        </div>
      </div>
